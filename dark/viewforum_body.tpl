...
<tr><td class="row1g-left tw100pct"><span class="post-text" style="font-weight:bold;"><!-- IF S_FORUM_RULES_TITLE --><center>{L_FORUM_RULES}</center><!-- ENDIF --></span></td></tr>
<tr><td style="background-color:#1d1e20;"><div class="post-text">{FORUM_RULES}</div></td></tr>
</table>{IMG_TBR}
<br />
<!-- ENDIF -->
...
<tr>
	<td class="tdnw">
		...
		<div id="icon_description">
			<table class="forumline">
			<tr>
				<td class="row1g-left tw100pct" colspan="6">
					<div class="max-min-right" style="{SHOW_HIDE_PADDING}"><img src="{IMG_MINIMISE}" onclick="ShowHide('icon_description','icon_description_h','icon_description');" alt="" /></div><span class="post-text" style="font-weight:bold;">{L_ICON_DESCRIPTION}</span>
				</td>
			</tr>
			<tr>
	...
	<td class="tw40pct tdalignr tdnw">
		...
		{IMG_TBL}<div id="topic_auth_list_h" style="display: none;">
			<table class="forumline">
			<tr>
				<td class="row1g-left tw100pct">
					<div class="max-min-right" style="{SHOW_HIDE_PADDING}"><img src="{IMG_MAXIMISE}" onclick="ShowHide('topic_auth_list','topic_auth_list_h','topic_auth_list');" alt="" />&nbsp;</div><span class="post-text" style="font-weight:bold;">{L_PERMISSIONS_LIST}</span>
				</td>
			</tr>
			</table>
		</div>
