...
<tr>
	<td class="gensmall tw40pct">
		{IMG_TBL}<div id="topic_auth_list_h" style="display: none;">
			...
			<tr>
				<td class="row1g-left tw100pct">
					<div class="max-min-right" style="{SHOW_HIDE_PADDING}"><img src="{IMG_MAXIMISE}" onclick="ShowHide('topic_auth_list','topic_auth_list_h','topic_auth_list');" alt="" />&nbsp;</div><span class="post-text" style="font-weight:bold;"><center>{L_PERMISSIONS_LIST}</center></span>
				</td>
			</tr>
			</table>
		</div>
		<div id="topic_auth_list">
			...
			<tr>
				<td class="row1g-left tw100pct">
					<div class="max-min-right" style="{SHOW_HIDE_PADDING}"><img src="{IMG_MINIMISE}" onclick="ShowHide('topic_auth_list','topic_auth_list_h','topic_auth_list');" alt="" />&nbsp;</div><span class="post-text" style="font-weight:bold;"><center>{L_PERMISSIONS_LIST}</center></span>
				</td>
			</tr>
